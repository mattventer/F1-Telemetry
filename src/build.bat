...
@set INCLUDES=/I imgui /I imgui\backends /I implot /I tinyxml2 /I "%WindowsSdkDir%Include\um" /I "%WindowsSdkDir%Include\shared"
@set SOURCES=main.cpp imgui\backends\imgui_impl_dx12.cpp imgui\backends\imgui_impl_win32.cpp imgui\imgui*.cpp implot\implot*.cpp tinyxml2\*.cpp
